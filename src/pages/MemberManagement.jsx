...
import { IconSearch, IconFilter, IconUser } from '../components/icons'
...
const MOCK_MEMBERS = [
  { id: 1, name: 'Sarah Chen', status: 'Active', email: 'sarah@gmail.com', phone: '(252) 555-0126', tastingCompleted: 23, tastingTotal: 30, comments: 12, favorites: 15 },
  { id: 2, name: 'James Wilson', status: 'Blocked', email: 'james@example.com', phone: '(252) 555-0127', tastingCompleted: 10, tastingTotal: 30, comments: 5, favorites: 8 },
  { id: 3, name: 'Emma Davis', status: 'Paused', email: 'emma@example.com', phone: '(252) 555-0128', tastingCompleted: 18, tastingTotal: 30, comments: 9, favorites: 11 },
  { id: 4, name: 'Michael Brown', status: 'Active', email: 'michael@example.com', phone: '(252) 555-0129', tastingCompleted: 28, tastingTotal: 30, comments: 14, favorites: 20 },
  { id: 5, name: 'Olivia Martinez', status: 'Active', email: 'olivia@example.com', phone: '(252) 555-0130', tastingCompleted: 15, tastingTotal: 30, comments: 7, favorites: 9 },
  { id: 6, name: 'William Taylor', status: 'Paused', email: 'william@example.com', phone: '(252) 555-0131', tastingCompleted: 22, tastingTotal: 30, comments: 11, favorites: 13 },
  { id: 7, name: 'Sophia Anderson', status: 'Blocked', email: 'sophia@example.com', phone: '(252) 555-0132', tastingCompleted: 8, tastingTotal: 30, comments: 3, favorites: 6 },
  { id: 8, name: 'Benjamin Thomas', status: 'Active', email: 'benjamin@example.com', phone: '(252) 555-0133', tastingCompleted: 30, tastingTotal: 30, comments: 18, favorites: 22 },
  { id: 9, name: 'Isabella Jackson', status: 'Active', email: 'isabella@example.com', phone: '(252) 555-0134', tastingCompleted: 19, tastingTotal: 30, comments: 8, favorites: 12 },
  { id: 10, name: 'Lucas White', status: 'Paused', email: 'lucas@example.com', phone: '(252) 555-0135', tastingCompleted: 14, tastingTotal: 30, comments: 6, favorites: 10 },
  { id: 11, name: 'Ava Harris', status: 'Blocked', email: 'ava@example.com', phone: '(252) 555-0136', tastingCompleted: 12, tastingTotal: 30, comments: 4, favorites: 7 },
  { id: 12, name: 'Henry Clark', status: 'Active', email: 'henry@example.com', phone: '(252) 555-0137', tastingCompleted: 25, tastingTotal: 30, comments: 13, favorites: 16 },
]
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex gap-6 items-start">
        {/* Left: section – background #F5F5F5; small divs #FAFAFA80, no borders; search/filter border #6D6D6D */}
        <div
          ...
          <div className="flex shrink-0 gap-2">
            <div className="relative min-w-0 flex-1">
              ...
              <input
                ...
                style={{ borderColor: '#6D6D6D', backgroundColor: '#FAFAFA80' }}
              />
            </div>
            <button
              type="button"
              ...
              style={{
                borderColor: '#6D6D6D',
                backgroundColor: isFilterOpen ? '#6D6D6D' : '#FAFAFA80',
            ...
            <div className="flex shrink-0 flex-col gap-2">
              ...
              <div className="relative">
                <button
                  ...
                  style={{ borderColor: '#6D6D6D', backgroundColor: '#FAFAFA80', color: whiskeyCompletions ? 'var(--color-text-strong)' : 'var(--color-text)' }}
                  ...
                  >
                    {WHISKEY_OPTIONS.map((opt) => (
                      <button
                        ...
                        className="flex w-full items-center gap-2 px-3 py-2 text-left text-sm font-medium text-[var(--color-text-strong)] hover:bg-[#F4F4F4] transition-colors"
                      >
                        {whiskeyCompletions === opt.value ? (
                          <svg className="h-4 w-4 shrink-0 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                        ) : (
          ...
          {!selectedMember ? (
            ...
            <>
              ...
              <div className="flex min-w-0 flex-1 gap-4">
                ...
                <div className="flex min-w-0 flex-1 flex-col gap-3 rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-white p-4">
                  ...
                  <div className="flex gap-4">
                    <div className="flex flex-1 flex-col items-center justify-center rounded-[var(--radius-md)] bg-[#6D6D6D] py-3 text-white">
                      <span className="text-lg font-bold">{selectedMember.comments}</span>
                ...
                {/* Status Management card – same size as Progress Overview */}
                <div className="flex min-w-0 flex-1 flex-col gap-3 rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-white p-4">
              ...
              {/* Section 3: Tasting History – inside parent card container (same as Progress Overview / Status Management) */}
              ...
              <div className="shrink-0 rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-white p-4">
                ...
                <div className="mb-3 flex gap-2">
                  <button
                    ...
                    className={`rounded-[var(--radius-md)] px-3 py-2 text-sm font-medium transition-colors ${
                      commentsFilter === 'all'
                        ? 'bg-[#F4F4F4] text-[var(--color-text-strong)]'
                ...
                <div className="flex flex-col gap-2">
                  {MOCK_COMMENTS.filter((c) => (commentsFilter === 'flagged' ? c.flagged : true)).map((comment) => (
                    <div
                      key={comment.id}
                      className="relative rounded-[var(--radius-md)] border border-[var(--color-border)] bg-white p-4"
                    >
                      {comment.flagged && (
                        <button
                          type="button"
                          className="absolute right-3 top-3 rounded p-1 text-[var(--color-text)] hover:bg-[#F4F4F4]"
                          aria-label="Flagged"
                        >
            ...
            >
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-[var(--radius-md)] border border-[var(--color-border)] bg-white px-3 py-2 text-sm text-[var(--color-text-strong)] focus:outline-none focus:ring-1 focus:ring-[#6D6D6D]"
                  placeholder="Name"
                />
              </div>
              <div>
